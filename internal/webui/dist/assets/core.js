...
export const state={refreshTimer:null,dialogSubmit:null,formError:null,secretValue:'',renderGeneration:0,
  page:'overview',version:'',config:null,data:null,range:'24h',paused:false,loading:false,routeID:'',routeDraft:null,simulation:null,requestPage:1,requestQ:'',requestStatus:'',requestProvider:'',modelFilters:{},usageDays:7,simulateMode:'claude-code',usageShowAll:false,sessionModel:'',modelQ:'',modelProtocol:'',providerFilter:'',providerUsage:null,playProtocol:'chat',playResult:null,playBusy:false,playSession:uid(),lastSync:0
};
